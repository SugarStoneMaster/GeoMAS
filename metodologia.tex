...
\begin{enumerate}
    ...
    \item \textbf{Validation and Execution Step:} The ActionEngine validates and executes the envelope against the WorldState. Defense actions use a waterfall priority resolver; economic and foreign actions are single-shot.
