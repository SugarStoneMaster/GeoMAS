...
\texttt{Declare\_War} & Sets the bilateral relationship to War and triggers a \textit{Call to Arms} notification to the victim's Mutual Defense allies. \\ \hline
\texttt{Propose\_Alliance} & Creates a pending proposal at a specified tier: Non-Aggression Pact or Mutual Defense. Requires that the proposer's trust towards the target is $\geq$ 40/100. \\ \hline
\texttt{Request\_Peace} & Creates a pending peace proposal for nations currently at war. \\ \hline
\texttt{Send\_Diplomatic\_Message} & Sends a typed message (Praise, Threat, Nuclear Threat, or Warning) with predefined trust impacts ($+3$ to $-10$). A five-turn cooldown per pair prevents spamming. \\ \hline
\texttt{Break\_Treaty} & Unilaterally dissolves an alliance, triggering a $-30$ trust penalty. \\ \hline
\texttt{Idle} & No diplomatic initiative this turn. \\ \hline
\end{tabular}
