...
\begin{itemize}
    \item \textbf{Declare\_War:} Sets relationship to War and triggers a \textit{Call to Arms} notification to the victim's mutual defense allies.
    ...
    \item \textbf{Send\_Diplomatic\_Message:} Typed messages (Praise, Insult, Threat, Nuclear Threat) with predefined trust impacts.
    \item \textbf{Break\_Treaty:} Unilaterally ends an alliance, incurring in a trust penalty.
\end{itemize}
