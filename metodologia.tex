...
\texttt{Send\_Diplomatic\_Message} & Sends a typed message (Praise, Threat, Nuclear Threat, Warning) with predefined trust impacts ($+3$ to $-10$). & Five-turn cooldown per pair prevents spamming. \\ \hline
