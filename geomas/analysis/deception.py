...
class DeceptionAnalyzer:
    ...
    # Rows: private_intent, Columns: public_intent
    # Score = how deceptive is claiming public when reality is private
    DEFENSE_MATRIX = {
        # Private is CONQUEST
        ...
        (DefenseIntentType.DEFENSE, DefenseIntentType.CONQUEST): 0.2,  # Understating
        ...
        (DefenseIntentType.IDLE, DefenseIntentType.CONQUEST): 0.4,  # Bluffing
    ...
    ECONOMIC_MATRIX = {
        # Private is SABOTAGE (most deceptive scenarios)
        ...
        (EconomicIntentType.SURVIVAL, EconomicIntentType.GROWTH): 0.4,  # Pretending strength
    ...
    FOREIGN_MATRIX = {
        # Private is DECEPTION (inherently deceptive)
        (ForeignIntentType.DECEPTION, ForeignIntentType.DECEPTION): 0.0,  # Meta-honest?
