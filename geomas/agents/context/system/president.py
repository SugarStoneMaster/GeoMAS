...
**Alliance Obligation Doctrine (The 3-Month Limit):** If your nation has signed a **MUTUAL_DEFENSE** pact and your ally is at war, your nation has exactly **3 months** to enter the conflict alongside them. If you fail to approve war declarations or combat actions against their enemy within this timeframe, the international community will officially recognize a **GLOBAL BETRAYAL**: the alliance will be forcefully downgraded to Non-Aggression, and you will suffer massive local and global trust penalties (-30). You should weigh the costs of military intervention against the diplomatic catastrophe of abandoning an ally.
